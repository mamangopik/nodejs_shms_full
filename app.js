...
//         //     console.log("data logged to local DB");    
//         // });
//         update_acc_data(topic,payload,obj.time_data).then(()=>{
//         })
//     } catch (error) {
//         console.log(error);
//     }
...
// const clientId_temp = `mqtt_${Math.random().toString(16).slice(3)}`
// const client_temp = mqtt.connect(connectUrl, {
//     clientId_temp,
//     clean: true,
//     connectTimeout: 4000,
//     reconnectPeriod: 1000,
//   })
//   const topic_temperature = '/hardware/cpu/temperature'
  
//   client_temp.on('connect', () => {
//     client_temp.subscribe([topic_temperature], () => {
//         console.log(`Subscribe to topic '${topic_temperature}'`);
//     })
//   })
  
//   client_temp.on('message', (topic, payload) => {
//       payload = payload.toString();
//       try {
//           hardware_info['temperature']=parseFloat(payload);
//           console.log(payload)
//       } catch (error) {
//           console.log(error);
//       }
